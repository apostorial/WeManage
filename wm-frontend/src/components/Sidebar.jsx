  ...
  return (
    <div className="side-bar">
      ...
      <div className="team-section">
				<div className="main-text">Team</div>
				<div className="sidebar-list">
					<a href="" className="sidebar-item">
      ...
      <div className="info-section">
        <div className="main-text">Information</div>
        <div className="sidebar-list">
          <a href="" className="sidebar-item">
          ...
          <a href="" className="sidebar-item-logout" onClick={handleLogout}>
            <svg className='sidebar-icon' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M12.4999 10H3.0166" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M4.87467 7.20834L2.08301 10L4.87467 12.7917" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>		
            <span>Logout</span>
          </a>
        </div>
